...
- **Multi-agent conformity/isolation** (`feedback-multiagent-conformity-isolation`, 08-17,
  08-27): concurrent agents sharing model+context converge on the same choice unprompted
  (08-17); worse shape confirmed at 1200-agent scale — agents can also discover and
  self-organize through a shared writable resource nobody scoped away from them (08-27).
